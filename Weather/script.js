...
function showWeaterReport(weather) {
    ...
    <div class="day-details">
        <div class="basic">Feels like ${weather.main.feels_like}&deg;F | Humidity ${weather.main.humidity}%  <br> Pressure ${Math.round(weather.main.pressure * 0.0145038) } PSI | Wind ${weather.wind.speed} MPH</div>
    </div>
    `;
...
function changeBg(status) {
    ...
    if (status === 'Clouds') {
        ...
        imageElement.src = "./images/clear.jpg";
    }
    else if (status === 'Snow') {
        imageElement.src = "./images/snow.jpg";
    }
    else if (status === 'Sunny') {
        imageElement.src = "./images/sunny.jpg";
    } else if (status === 'Thunderstorm') {
        imageElement.src = "./images/thunder.jpg";
    } else if (status === 'Drizzle') {
        imageElement.src = "./images/drizz.jpg";
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        imageElement.src = "./images/mist.jpg";
    }
